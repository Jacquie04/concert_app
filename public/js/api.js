    ...
    function searchConcert(event) {
        ...
        $.ajax({
            ...
            for (var i = 14; i < concert.length; i--) {
                ...
                var concertName = $("<p class='concert-name'>").text("Artist/Band Name/Event: " + concert[i].name);
                ...
                var concertDate = $("<p class='concert-date'>").text("Concert Date: " + convertedDate);
                ...
                var concertTime = $("<p class='concert-time'>").text("Concert Time: " + standardConcertTime);
                var concertVenue = $("<p class='concert-venue'>").text("Venue Name: " + concert[i]._embedded.venues[0].name);
